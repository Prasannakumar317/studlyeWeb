...
const mockFounders = [
  ...
  { id: "f-2", name: "Sarah Croft", role: "Co-Founder & CTO", company: "Aether AI", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=120", bio: "Systems reliability researcher and compiler optimization enthusiast. Interested in Rust infrastructure.", skills: ["Rust", "Kubernetes", "Linux Kernel"], location: "San Francisco, USA" },
  { id: "f-3", name: "Vikram Mehta", role: "Founder & CEO", company: "FinFlow", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=120", bio: "Ex-Razorpay PM. Building transaction layers that work without high-speed internet protocols in tier-3 regions.", skills: ["Product Management", "Payment APIs", "Strategy"], location: "Mumbai, India" },
  { id: "f-4", name: "Neha Roy", role: "Founder & Lead Biologist", company: "Helix Health", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=120", bio: "PhD in Computational Genomics from IISc. Designing hybrid transformers that recognize mutation outcomes.", skills: ["Genomics", "PyTorch", "Medical Workflows"], location: "New Delhi, India" }
];
